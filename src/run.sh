...
# This shell script shows the execution sequences for Dy-COPECA (Short-cicuted version). We need to have a c prgoram and set of test input. This tool is useful to check the adequecy of test inputs generated. This tool provides you the MC/DC report.
